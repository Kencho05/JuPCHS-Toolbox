...
$$x^{+} = x + \frac{\tau}{2} (f(x) + f(x^+))$$

## Backward Differentiation Formulas (BDF)


$$x^{+} = \frac{18}{11}x - \frac{18}{11}x_{k-1} + \frac{18}{11}x_{k-2} + \tau \frac{6}{11}f(x^+) $$

## Explicit/implicit 

See [[Alejandro Garcés-Ruiz et al. 2024]](https://www.sciencedirect.com/science/article/pii/S2405896324010176) for more details.
...
---
Readme: [Back to Readme](../README.md)